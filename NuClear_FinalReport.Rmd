...
```{r loading library and data, echo=FALSE, include=FALSE}
...
```{r rad_value summary, echo=TRUE, include=TRUE}
summary(DF_l)
```
...
```{r add interval, echo=FALSE, include=FALSE}
...
```{r daily dose rate, echo=FALSE, include=FALSE}
...
```{r violin_all, echo=FALSE, include=TRUE}
...
```{r violin_year, echo=FALSE, include=TRUE}
...
```{r violin_season, echo=FALSE, include=TRUE}
...
```{r loading and preparing location information, echo=FALSE, include=FALSE}
...
```{r year_inside_station , echo=FALSE, include=FALSE}
...
```{r year_outside_station , echo=FALSE, include=FALSE}
#outside
...
```{r year_map_data , echo=FALSE, include=FALSE}
# 2014
...
```{r year_map_draw , echo=FALSE, include=FALSE}
# 2014
...
```{r 2014_map_show , echo=FALSE, include=TRUE}
twcmap_2014 <- ggplot() +
...
```{r 2015_map_show , echo=FALSE, include=TRUE}
twcmap_2015<-ggplot() +
...
```{r 2016_map_show , echo=FALSE, include=TRUE}
twcmap_2016<-ggplot() +
...
```{r 2017_map_show , echo=FALSE, include=TRUE}
twcmap_2017<-ggplot() +
...
```{r loading inside stations, echo=FALSE, include=FALSE}
...
```{r map_outside, echo=FALSE, include=FALSE}
...
```{r combine inside and outside , echo=FALSE, include=FALSE}
DF_allseason_rad_mean <- rbind(DF_iseason_rad_mean,DF_oseason_rad_mean)
```

```{r season_map_data , echo=FALSE, include=FALSE}
# Spring
...
```{r season_map_draw , echo=FALSE, include=FALSE}
# Spring
...
```{r spring_map_show , echo=FALSE, include=TRUE}
...
```{r summer_map_show , echo=FALSE, include=TRUE}
...
```{r fall_map_show , echo=FALSE, include=TRUE}
twcmap_fall <- ggplot() +
...
```{r winter_map_show , echo=FALSE, include=TRUE}
...
```{r air_value summary, echo=TRUE, include=TRUE}
summary(Air_DF_New)
```
...
```{r outliers_pre, echo=FALSE, include=FALSE}
...
```{r outliers, echo=TRUE, include=TRUE}
...
```{r get outliers_stations, echo=TRUE, include=TRUE}
